function loadDataset_pie_2015(datasetPath) {
  ...
  d3.csv(datasetPath).then(function(data) {
    ...
    d3.select("#chart-container_2015").html("");
    d3.select("#pie-chart_2015").html("");
    drawChart_pie_2015(data);
  });
}

function drawChart_pie_2015(data) {
  ...
  svg
    ...
    .on("click", function(d) {
      if (selectedBar === this) {
        ...
        d3.select("#pie-chart_2015").style("display", "none"); 
        ...
        d3.select("#pie-chart_2015").style("display", "block"); 
      ...
      d3.csv("./data-pie/2015_pie/2015_" + d.name + ".csv").then(function(grantingData) {
  ...
  const pieSvg = d3.select("#pie-chart_2015")
  .append("svg")
...
function updatePieChart(data) {
  ...
  d3.select("#legend-panel").style("display", "block");
  d3.select("#pie-chart_2015").select(".legend").remove();
  data.forEach(function(d) {
    d.value = +d.value;
  });

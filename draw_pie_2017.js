function loadDataset_pie_2017(datasetPath) {
  ...
  d3.csv(datasetPath).then(function(data) {
    ...
    d3.select("#chart-container_2017").html("");
    d3.select("#pie-chart_2017").html("");
    drawChart_pie_2017(data);
  });
}

function drawChart_pie_2017(data) {
  ...
  svg
    ...
    .on("click", function(d) {
      if (selectedBar === this) {
        ...
        d3.select("#pie-chart_2017").style("display", "none"); 
        ...
        d3.select("#pie-chart_2017").style("display", "block"); 
      ...
      d3.csv("./data-pie/2017_pie/2017_" + d.name + ".csv").then(function(grantingData) {
  ...
  const pieSvg = d3.select("#pie-chart_2017")
  .append("svg")
...
function updatePieChart(data) {
  ...
  d3.select("#legend-panel").style("display", "block");
  d3.select("#pie-chart_2017").select(".legend").remove();
  data.forEach(function(d) {
    d.value = +d.value;
  });

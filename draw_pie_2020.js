function loadDataset_pie_2020(datasetPath) {
  ...
  d3.csv(datasetPath).then(function(data) {
    ...
    d3.select("#chart-container_2020").html("");
    d3.select("#pie-chart_2020").html("");
    drawChart_pie_2020(data);
  });
}

function drawChart_pie_2020(data) {
  ...
  svg
    ...
    .on("click", function(d) {
      if (selectedBar === this) {
        ...
        d3.select("#pie-chart_2020").style("display", "none"); 
        ...
        d3.select("#pie-chart_2020").style("display", "block"); 
      ...
      d3.csv("./data-pie/2020_pie/2020_" + d.name + ".csv").then(function(grantingData) {
  ...
  const pieSvg = d3.select("#pie-chart_2020")
  .append("svg")
...
function updatePieChart(data) {
  ...
  d3.select("#legend-panel").style("display", "block");
  d3.select("#pie-chart_2020").select(".legend").remove();
  data.forEach(function(d) {
    d.value = +d.value;
  });
